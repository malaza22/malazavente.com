            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach ($commandeMobile as $commandes)
                                <tr>
                                    <td>{{$commandes->id}}</td>
                                    ...
                                    <td>
                                            <input type="checkbox" class="commandesMobileStatus btn btn-success"
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('/admin/CommandeMobile-delete/'.$commandes->id)}}" class="btn btn-outline-danger"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
...
@section('script')
    ...
    $(".commandesMobileStatus").change(function(){
                ...
                if($(this).prop("checked")==true){
                    $.ajax({
                        ...
                        type : 'post',
                        url : '/admin/update-commandeMobile-status',
                        data : {status:'1',id:id},

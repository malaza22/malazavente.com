        ...
        <div class="row p-4 rounded shadow-sm">
            <div class="col-sm-6">
                    ...
                    <div class="p-3">
                        ...
                        <p class="font-italic mb-4"><b>Payment est valide !! veuiller imprimer ou engeristre la facture sous forme d'un pdf</b></p>
                       </div>
            </div>
            <div class="col-sm-6">
                ...
                <div class="p-4">
                  ...
                  <div class="row">
                      <a href="{{route('checkout.mobile')}}"  class="col-sm-6 btn btn-sm btn-dark rounded-pill py-2"><i class="fa fa-print"></i> Generé Print</a>
